      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="w-full max-w-md text-center">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5 sm:p-8">
            ...
            <Link
              href="/auth/login"
              className="mt-6 inline-block text-sm font-medium text-navy hover:text-navy-light transition-colors py-2"
            >
              Back to sign in
            </Link>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:border-navy focus:ring-1 focus:ring-navy outline-none transition-colors"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-lg bg-navy px-4 py-3 text-sm font-medium text-white hover:bg-navy-light transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
