  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside
          className={`fixed inset-y-0 left-0 z-50 w-64 transform border-r border-gray-200 bg-white pt-14 transition-transform duration-200 lg:static lg:z-0 lg:translate-x-0 lg:pt-0 ${
            sidebarOpen ? "translate-x-0" : "-translate-x-full"
          }`}
        >
          {/* Mobile close */}
          <div className="flex items-center justify-between px-4 py-3 lg:hidden">
            <span className="font-heading text-sm font-semibold text-navy">Menu</span>
            <button
              type="button"
              onClick={() => setSidebarOpen(false)}
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4">
            <div className="rounded-xl bg-gradient-to-br from-navy to-navy-light p-4 text-white">
              ...
              <p className="mt-1 text-[11px] leading-relaxed opacity-60">
                Upload docs, build a persona, then generate funnel content.
              </p>
            </div>
          </div>
        </aside>
        ...
        {/* Main content */}
        <main className="flex-1 min-h-[calc(100vh-3.5rem)] px-4 py-6 sm:px-6 lg:px-8">
